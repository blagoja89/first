				...
				<ol type="1">
					...
					<li class="submenu"><a name="train.add"><fmt:message
						...
						<form method="POST" action="Controller"
							accept-charset="UTF-8">
							<input type="hidden" name="command" value="admin" /> <input
								type="hidden" name="admin" value="train" /> 
							<table>
								<tr>
									<td class="adminForm1"><fmt:message key="departure.date" /></td>
									<td><input type="date" name="date" required="date" /></td>
								</tr>
								<tr>
									<td class="adminForm1"><fmt:message key="time" /></td>
									<td><input type="time" name="time" required="time" /></td>
								</tr>
								<tr>
								
					 			<td><select name="trainItem" size="1" onchange="return setValue();">
									<option>
										<fmt:message key="number.train" />
									</option>
