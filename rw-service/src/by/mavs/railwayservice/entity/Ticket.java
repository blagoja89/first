...
public class Ticket extends Entity {
	...
	public DBProperty getDbProperty() {
		...
		dbProperty.getDbSimplePropertyItems().add(new DBSimplePropertyItem("timeDeparture", "TIME_DEPARTURE", String.class));
		dbProperty.getDbSimplePropertyItems().add(new DBSimplePropertyItem("timeArrival", "TIME_ARRIVAL", String.class));
