	...
	<div class="adminMiddle">
			...
			<ol type="I">
				...
				<ol type="1">
					...
					<li class="submenu"><a href="#message.type.search"><fmt:message
								key="search.type" /></a></li>
					<li class="submenu"><a href="#message.select.all"><fmt:message
								key="select.all" /></a></li>
					<li class="submenu"><a href="#message.response.change"><fmt:message
								key="change.response" /></a></li>
				</ol>
				
				<li class="mainMenu"><a href="#train"><fmt:message
							key="train" /></a></li>
				<ol type="1">

					<li class="submenu"><a href="#train.add"><fmt:message
								key="train.add" /></a></li>
				</ol>
			</ol>
			...
			<ol type="I">
				...
				<li class="mainMenu"><a name="password"><fmt:message
							key="password" /></a></li>
				...
				<li class="mainMenu"><a name="user"><fmt:message
							key="user" /></a></li>
					...
					<li class="submenu"><a name="user.status"><fmt:message
						...
						<form method="POST" action="/Controller"
							...
							<table>
								...
								<li class="mainMenu"><a name="message"><fmt:message
							key="message" /></a></li>
				
				
				<ol type="1">
					<li class="submenu"><a name="message.select.all"><fmt:message
								key="select.all" /></a>
						<form method="POST" action="/Controller"
							accept-charset="UTF-8">
							<input type="hidden" name="command" value="admin" /> <input
								type="hidden" name="admin" value="message" /> <input
								type="hidden" name="type" value="select" /> <input
								type="hidden" name="message" value="search.all" />
							<table>
								<tr>
									<td colspan="2"><input type="submit" name="submit"
										value="${submit}" /></td>
						...
						<li class="mainMenu"><a name="train"><fmt:message
							key="train" /></a></li>
				
				
				<ol type="1">
						
					<li class="submenu"><a name="train.add"><fmt:message
								key="train.add" /></a>
						<form method="POST" action="/Controller"
							accept-charset="UTF-8">
							<input type="hidden" name="command" value="admin" /> <input
								type="hidden" name="admin" value="train" /> <input
								type="hidden" name="type" value="add" />
							<table>
								<tr>
									<td class="adminForm1"><fmt:message key="enter.train.date" /></td>
									<td><input type="date" name="date" required="date" /></td>
								</tr>
								<tr>
									<td class="adminForm1"><fmt:message key="enter.train.time" /></td>
									<td><input type="time" name="time" required="time" /></td>
								</tr>
								<tr>
									<td class="adminForm1"><fmt:message
											key="train.number" /></td>
