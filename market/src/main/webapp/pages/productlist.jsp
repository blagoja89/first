...
<body>
	<div id="main">
		<nested:root name="productForm">
			<nested:form
				action="/marketAction.do?method=save&catIndex=${productForm.catIndex}&subcatIndex=${productForm.subcatIndex}"
				styleId="productForm">
				<div id="block">
					<table cellpadding="6">
						<tr>
					...
					<div class="buttonsBar">
						<a class="myButton"
							href="marketAction.do?method=subcatlist&catIndex=${productForm.catIndex}">Back</a>
						<a class="myButton" id="saveButton" href=""
							onclick="document.getElementById('productForm').submit(); return false;">Save</a>
						<a class="myButton"
							href="marketAction.do?method=add&catIndex=${productForm.catIndex}&subcatIndex=${productForm.subcatIndex}">Add</a>
					</div>
				</div>
			</nested:form>
		</nested:root>
